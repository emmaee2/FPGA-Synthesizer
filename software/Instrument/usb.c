...
void UsbWrite(alt_u16 Address, alt_u16 Data)
{
	...
	IO_write(HPI_ADDR, Address); // Write address
	IO_write(HPI_DATA, Data); // Write data to that address
...
alt_u16 UsbRead(alt_u16 Address)
{
	...
	IO_write(HPI_ADDR, Address); // write address we want to read from
	return
			IO_read(HPI_DATA); // return the data from that address
}
